...
/*   Updated: 2026/02/10 17:55:48 by kbrun            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_conditions(char c, va_list argp)
{
	...
	if (c == '%')
		...
		count += ft_print_str(va_arg(argp, char *));
	else if (c == 'x' || c == 'X')
		count += ft_print_base(c, va_arg(argp, unsigned int), 16);
	else if (c == 'd' || c == 'i')
		count += ft_print_base(c, va_arg(argp, int), 10);
	else if (c == 'u')
		count += ft_print_base(c, va_arg(argp, unsigned int), 10);
	else if (c == 'p')
		count += ft_check_pntr(va_arg(argp, void *));
	return (count);
}
...
int	ft_printf(const char *s, ...)
{
	...
	while (s[i] != '\0')
	{
		if (s[i] == '%')
		{
			count += print_conditions(s[i + 1], argp);
			i = i + 2;
		}
		else
		{
